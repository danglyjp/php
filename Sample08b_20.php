...
if (isset($_POST["i"])) {
    switch ($_POST["i"]) {
        case 1:
            ...
            break;
        case 2:
            $ir = "background-color:blue";
            $ci2 = "checked";
            break;
        case 3:
            $ir = "background-color:red";
            $ci3 = "checked";
            break;
    }
}

echo "<table border='1' style='$ir'  ";
...
echo "<p>";
echo "色：";
echo "<input type='radio' name='i'  value='1'" . $ci1 . ">black    ";
echo "<input type='radio' name='i'  value='2'" . $ci2 . ">green    ";
echo "<input type='radio' name='i'  value='3'" . $ci3 . ">red    ";
echo "</p>";
